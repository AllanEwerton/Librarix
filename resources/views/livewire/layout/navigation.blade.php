...
<nav x-data="{ open: false }" class="bg-azul-escuro border-b border-cinza-medio pt-10 fixed top-0 inset-x-0 z-50 shadow">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white hover:text-amarelo-ouro hover:bg-azul-celeste focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-azul-celeste transition ease-in-out duration-150">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-azul-claro">
        ...
        <div class="pt-4 pb-1 border-t border-cinza-medio">
            <div class="px-4">
                ...
                <div class="font-medium text-sm text-cinza-medio">{{ auth()->user()->email }}</div>
            </div>
